...
if ${use_color} ; then
	...
	if [[ ${EUID} == 0 ]] ; then
        ...
        #PS1='\[\033[01;37;46m\] Working Directory is \w\033[K\[\033[00m\]\n\[\033[00;33m\][!\!]\[\033[01;34m\] \# \[\033[01;36m\]~>\[\033[0m\] '
	fi
...
__conda_setup="$('/run/media/ponder/ssd0/tools/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/run/media/ponder/ssd0/tools/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/run/media/ponder/ssd0/tools/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/run/media/ponder/ssd0/tools/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
